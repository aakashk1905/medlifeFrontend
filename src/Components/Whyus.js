      ...
      <div className="wu-inner-cont">
        ...
        <div className="wu-right-cont">
          ...
          <div className="wu-pts-cont">
            <div className="wu-pts">
              <div className="wu-svg-cont">
                <svg
                ...
                >
                  ...
                  <path
                    d="M13.5775 8.64727L9.14801 12.6886C9.10943 12.7239 9.06359 12.7519 9.01312 12.771C8.96264 12.7902 8.90852 12.8 8.85387 12.8C8.79921 12.8 8.7451 12.7902 8.69462 12.771C8.64415 12.7519 8.5983 12.7239 8.55973 12.6886L6.62184 10.9205C6.58321 10.8853 6.55257 10.8434 6.53166 10.7974C6.51076 10.7513 6.5 10.702 6.5 10.6521C6.5 10.6023 6.51076 10.5529 6.53166 10.5069C6.55257 10.4608 6.58321 10.419 6.62184 10.3838C6.66047 10.3485 6.70632 10.3206 6.75679 10.3015C6.80726 10.2824 6.86135 10.2726 6.91598 10.2726C6.97061 10.2726 7.0247 10.2824 7.07517 10.3015C7.12564 10.3206 7.1715 10.3485 7.21013 10.3838L8.85421 11.8838L12.9899 8.11116C13.0679 8.03999 13.1737 8 13.284 8C13.3943 8 13.5001 8.03999 13.5782 8.11116C13.6562 8.18234 13.7 8.27887 13.7 8.37953C13.7 8.48019 13.6562 8.57672 13.5782 8.6479L13.5775 8.64727Z"
                    fill="white"
                  />
                </svg>
              </div>
              <div className="wu-pts-text">Excellence in Healthcare</div>
            </div>
            <div className="wu-pts">
              <div className="wu-svg-cont">
                <svg
              ...
              <div className="wu-pts-text">Patient-Centric Care</div>
            </div>
            <div className="wu-pts">
              <div className="wu-svg-cont">
                <svg
              ...
              <div className="wu-pts-text"> Personalized Approach</div>
            </div>
            <div className="wu-pts">
              <div className="wu-svg-cont">
                <svg
              ...
              <div className="wu-pts-text">State-of-the-Art Facilities</div>
            </div>
            <div className="wu-pts">
              <div className="wu-svg-cont">
                <svg
              ...
              <div className="wu-pts-text">Transparent Pricing</div>
            </div>
            <div className="wu-pts">
              <div className="wu-svg-cont">
                <svg
              ...
              <div className="wu-pts-text">Coordinated Care</div>
            </div>
          </div>
