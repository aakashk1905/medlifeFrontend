      ...
      <div className='w-[95%] md:w-4/5'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-7">
          ...
          <div className="shadow-lg rounded-lg flex flex-col">
            ...
            <div className="px-4 flex flex-col items-start justify-between h-full py-2 box-border">

            <h1 className="text-gray-600 text-2xl font-semibold flex justify-between items-center w-full">
            Orchid Hospital
            <span className='text-gray-500 text-xl'>Since 2004</span>
            </h1>
            
            <p className="text-gray-500 text-justify flex gap-2">
  ...
  <li>24 hour Emergency Services</li>
          ...
          <div className="shadow-lg rounded-lg">
            ...
            <p className="text-gray-500 mb-3 text-justify flex gap-2">
              <FaLocationDot className='text-3xl'></FaLocationDot>
              Located in the heart of Patna, CISRO is a super-specialty hospital, dedicated to Ortho, Spine, Neuro, and Rehabilitation. The hospital is equipped with state-of-the-art technologies and several...
            </p>
            <button onClick={()=>document.getElementById('my_modal_4').showModal()} className="bg-gray-200 rounded-lg p-3 font-semibold text-purple-800">
              View Hospital
            </button>
...
<dialog id="my_modal_4" className="modal">
  <div className="modal-box p-0 ">
    <form method="dialog">
     ...
     <p className='text-gray-500 mb-3 text-justify font-lato'>Located in the heart of Patna, CISRO is a super-specialty hospital, dedicated to Ortho, Spine, Neuro, and Rehabilitation. The hospital is equipped with state-of-the-art technologies and several latest equipment which make it a powerhouse of healthcare in Bihar. With its commitment to invest in latest medical technology, CISRO ensures that each one of its patients get the access to supreme healthcare.</p>
     <h1 className="text-gray-600 text-2xl font-semibold mb-1 font-lato">
     Our Specialties:
            </h1>

            <p className='mb-3 font-lato'>The hospital is equipped with state-of-the-art technologies and several latest equipment which make it a powerhouse of healthcare in Bihar. With its commitment to invest in latest medical technology, CISRO ensures that each one of its patients get the access to supreme healthcare.</p>
