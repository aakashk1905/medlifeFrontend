 ...
 <div className='flex items-center flex-col mt-2 mb-10 h-full'>
        ...
        <div className="bg-[#E3E3E3] w-full h-0.5 mb-8"></div>
            ...
            <div className='shadow-lg p-3 rounded-lg'>
                ...
                <p className='mb-1'><span className='font-bold text-gray-800'>Name:</span> <span className='text-gray-700'>MEDLIFEEASY PRIVATE LIMITED</span></p>
                <p className='mb-1'><span className='font-bold text-gray-800'>A/C:</span> <span className='text-gray-700'>030705009211</span></p>
                <p className='mb-1'><span className='font-bold text-gray-800'>IFSC:</span> <span className='text-gray-700'>ICIC0000307</span></p>
