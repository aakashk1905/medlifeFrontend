...
<li className="text-gray-600 text-justify list-disc">By applicable law</li>
<li className="text-gray-600 text-justify list-disc">By professional/legal advisers, directors, employees/agents/representatives of MEDLIFEEASY in connection with these terms or otherwise</li>
<li className="text-gray-600 text-justify list-disc">For investigating potential violations of the terms herein or applicable national & international laws</li>
<li className="text-gray-600 text-justify list-disc">For investigating deliberate damage to the services or its legitimate operation</li>
<li className="text-gray-600 text-justify list-disc">For responding to service support requests, or</li>
<li className="text-gray-600 text-justify list-disc">For protecting the rights, property, or safety of MEDLIFEEASY and/or its Directors, employees, and the public at large.</li>
<li className="text-gray-600 text-justify list-disc">Use of Website, The User represents warrants and covenants that his/her use of the website shall not:</li>
<li className="text-gray-600 text-justify list-disc">Violate any applicable local, provincial, state, national or international law, statute, ordinance, rule, or regulation</li>
<li className="text-gray-600 text-justify list-disc">Interfere with or disrupt computer networks connected to the website</li>
<li className="text-gray-600 text-justify list-disc">Impersonate any other person or entity or make any misrepresentation as to his/her association with any other person or entity</li>
<li className="text-gray-600 text-justify list-disc">Upload, post, transmit, publish, or distribute any material or information for which he/she does not have all necessary rights and licenses</li>
<li className="text-gray-600 text-justify list-disc">Upload, post, transmit, publish, or distribute any material which infringes, violates, breaches or otherwise contravenes the rights of any third party, including any copyright, trademark, patent, rights of privacy or publicity or any other proprietary right.</li>
<li className="text-gray-600 text-justify list-disc">Interfere with or disrupt the use of the website by any other user, nor “stalk”, threaten, or in any manner harass another user</li>
...
<li className="text-gray-600 text-justify list-disc">Use the website in such a manner as to gain unauthorized entry or access to the computer systems of others.</li>
<li className="text-gray-600 text-justify list-disc">Upload, post, transmit, publish, or distribute any material or information which constitutes or encourages conduct that would constitute a criminal offence, give rise to other liability, or otherwise violate applicable law.</li>
