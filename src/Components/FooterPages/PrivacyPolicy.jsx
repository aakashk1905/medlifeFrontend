        ...
        <div className="mb-10">
          <div className="px-10">
            ...
            <p className="text-gray-700 mb-5">
              This privacy policy governs your use of the website, Web
              Application & MEDLIFEEASY App("Application") for web & mobile
              devices.
            </p>
          </div>
          ...
          <div className="px-10">
            ...
            <div className="mb-9">
              <h2 className="text-2xl font-medium text-gray-700 mb-2">
                1. What information does the Application obtain and how is it
                used? User Provided Information
              </h2>
              <p className="text-gray-600 text-justify">
                ...
                optional. However, please keep in mind that you may not be able
                to use some of the features offered by the Application unless
                you register with us. <br />
                ...
                offers, or download or use applications from us; (c) information
                you provide us when you contact us for help; (d) credit card
