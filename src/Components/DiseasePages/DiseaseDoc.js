          ...
          <div className="dd-card">
            <div className="dd-top">
              ...
              <div className="dd-top-right">
                <div className="dd-top-head">Dr. Sahajanad Prasad</div>
                <div className="dd-top-text">
                  {" "}
                  MBBS, MS- <b style={{ color: "#00A0AA" }}>General sergery</b>
                </div>
                <div className="dd-top-sub-head"> Specialization</div>
                <div className="dd-top-sp-cont">
                  <div className="dd-top-sp">General surgeon</div>
                  <div className="dd-top-sp">Neurosurgeon</div>
                  <div className="dd-top-sp">Orthopedic Surgeon</div>
                </div>
