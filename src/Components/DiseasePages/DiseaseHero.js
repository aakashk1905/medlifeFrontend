        ...
        <div className="dh-left">
          ...
          <div className="dh-left-mid">
            <div className="dh-left-det-cont">
              <div className="dh-left-head">
                Advance <br />
                Laproscopic surgery <br />
                <b className="dh-left-head-col">सुरक्षित एवं सफल</b>
              </div>
              <div className="dh-left-text">
                लेप्रोस्कोपिक सर्जरी (Laproscopic Surgery), एक न्यूनतम इनवेसिव
                दृष्टिकोण, सर्जरी के क्षेत्र में एक गेम-चेंजर बन गया है, जो
                रोगियों को कई लाभ प्रदान करता है। Medlife Easy में, हम इस
                अत्याधुनिक तकनीक को बिहार में सभी के लिए सुलभ बनाने के लिए
                प्रतिबद्ध हैं।{" "}
              </div>
              <div className="dh-pts-cont">
                <div className="dh-left-pts">
                  <svg
