...
const Surgeries = () => {
  ...
  const displayedSurgeries = showAllCards ? surgeriesData : surgeriesData.slice(0, 8);
  ...
  return (
    <div className="py-10 flex justify-center">
      <div className="bg-white shadow-md w-[95%] md:w-[90%] rounded-xl p-5 md:p-10 border-t border-gray-100 flex flex-col gap-[50px] items-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 2xl:grid-cols-9 w-full max-w-[90%] gap-9">
          {displayedSurgeries.map((surgery, index) => (
            <div key={index} className="flex flex-col items-center">
              <img className="mb-0.5 border border-[#E1E3E4] rounded-lg bg-[#FFF] w-20 p-2" src={surgery.image} alt={surgery.name} />
        ...
        <div className="flex justify-center">
          <button className="flex items-center text-lg px-3 py-2 rounded-lg border border-[#00A79D] text-[#00A79D]" onClick={handleClick}>
